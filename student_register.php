	...
	if ($fn && $e && $p && $phone) { // If everything's OK...
		...
		if (mysqli_num_rows($r) == 0) { // Available.
			...
			*/
			...
			$q = "INSERT INTO users (email, pass, fullname, user_level, membership, registration_date, phone) VALUES ('$e', SHA1('$p'), '$fn','2', '$membership', NOW(), '$phone')";
			$r = mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc));
...
<div class="container-fluid">
   <form form action="student_register.php" method="post" role="form">
    <div class="form-group">
