...
echo '<h1 style="color:red;"> الوقت المتبقي : ';
...
elseif ( (isset($_POST['id2'])) && (is_numeric($_POST['id2'])) )
	...
	if ($questions_count !=0)
	{
		...
		else
		{
			...
			echo '<form action="real_test2.php" method="post">';
		...
		if ($next < $pages_count)
{
 ...
 if ($next >= $questions_count )
	 {
	   echo ' - ';
	   echo '<button name="id2" class="btn btn-danger btn-md" type="submit" value="' . $page . '">تسليم الاختبار</button>';
	 }
